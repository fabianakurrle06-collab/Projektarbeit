...
class CoffeeOrderTest {
    ...
    public void testBerechnePreis() {
        ...
        CoffeeOrder tesOrder = new CoffeeOrder("Espresso", false, "Small", false, false, "Milch", 1);
    ...
    public void testBeechnePreisExtras() {
        ...
        CoffeeOrder order = new CoffeeOrder("Latte Macchiato", false, "Large", false, true, "Hafermilch", 1);
    ...
    public void testBerechnePreisMulitplikation() {
        ...
        CoffeeOrder order = new CoffeeOrder("Americano", false, "Medium", false, false, "Milch", 3);
